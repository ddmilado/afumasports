...
const Electrical = () => {
  ...
  const { data: products, isLoading, error } = useProducts('', 'Electrical');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-sm text-gray-500 mb-6 pt-32">
          ...
          <Link to="/products" className="hover:text-slate-500"> Products</Link> / Electrical Parts
        </div>

        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Electrical Parts</h1>
            <p className="text-gray-600">Advanced electrical components for modern vehicles</p>
          </div>
        ...
        {isLoading ? (
          <div className="text-center py-8">
            <p className="text-gray-600">Loading electrical parts...</p>
          </div>
        ) : error ? (
          <div className="text-center py-8">
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600">Showing {products?.length || 0} electrical parts</p>
            </div>
            ...
            {products?.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-600">No electrical parts found.</p>
              </div>
            )}
          </>
        )}
