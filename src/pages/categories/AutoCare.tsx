...
const AutoCare = () => {
  ...
  const { data: products, isLoading, error } = useProducts('', 'Auto Care');
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-sm text-gray-500 mb-6 pt-32">
          ...
          <Link to="/products" className="hover:text-slate-500"> Products</Link> / Auto Care
        </div>

        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Auto Care Products</h1>
            <p className="text-gray-600">Premium care products to keep your vehicle looking its best</p>
          </div>
        ...
        {isLoading ? (
          <div className="text-center py-8">
            <p className="text-gray-600">Loading auto care products...</p>
          </div>
        ) : error ? (
          <div className="text-center py-8">
          ...
          <>
            <div className="flex items-center justify-between mb-6">
              <p className="text-gray-600">Showing {products?.length || 0} auto care products</p>
            </div>
            ...
            {products?.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-600">No auto care products found.</p>
              </div>
            )}
          </>
        )}
